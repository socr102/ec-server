...
<script>
    $(document).ready(function () {
        $('#homepage-navigator, #competition-navigator').addClass('active');
    });
</script>
@endsection
@section('content')
            ...
            <div class="container">
                <div class="base-page-card full">
                    <div class="base-page-card-header">
                        <div class="page-title">
                            <div class="hold">
                                ...
                                <h5>Eatchefs <span>Competition</span></h5>
                            </div>
                        </div>
                    </div>
                    <div class="base-page-card-content overflow-hidden align-items-center d-flex mb-lg-4">
                                        ...
                                        <div class="competition-body">
                                            <div class="desc">
                                                <p>
                                                    ...
                                                    impedit
                                                    ea
                                                    dolorum doloremque, atque quibusdam. Quas ducimus nesciunt, veniam,
                                                    maiores
                                                    voluptatum eius id fugiat velit asperiores quisquam itaque! Adipisci,
                                                    iusto.
                                                </p>
                                                <p>
                                                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Pariatur, eos.
                                                    Voluptates
                                                    debitis eaque pariatur vel ullam omnis natus culpa, aliquam
                                                    reprehenderit
                                                    officia
                    ...
                    <div class="base-page-card-footer">
                        <div class="enroll">
                            <a class="enroll-btn"
                                href="{{ route('home.home-chef.dish.new-dish.step-1') }}">Enroll
                                Now
                            </a>
                        </div>
                    </div>
