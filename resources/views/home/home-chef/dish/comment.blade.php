...
<div class="dashboard-wrapper">
    ...
    <div class="base-page dish-page comment-page">
        <div class="container">
            <div class="base-page-card">
                ...
                <div class="base-page-card-content">
                    <div class="navigator-row row">
                        <a class="col-6 active" href="{{ route('home.home-chef.dish.dish', ['id'=>$id]) }}">
                            Main Info
                        </a>
                        <a class="col-6" href="{{ route('home.home-chef.dish.details', ['id'=>$id]) }}">
                            Details
                        </a>
                    </div>
                    <div class="card-hold">
            ...
            {{-- @include('layouts.bottom-nav.home-chef.order-navigator') --}}
        </div>
    </div>
