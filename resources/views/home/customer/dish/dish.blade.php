    ...
    <div class="base-page dish-page">
        <div class="container">
            <div class="base-page-card full">
                ...
                <div class="base-page-card-content d-lg-none">
                    <div class="navigator-row row">
                        <a class="col-4 active" href="{{ route('home.customer.dish.dish', ['id'=>$dish->id_dish]) }}">
                            Main Info
                        </a>
                            ...
                            <div class="competition-phase">
                                <div class="card">
                                    ...
                                    <div class="share-row row">
                                        ...
                                        <div class="col-4">
                                            <a class="share-item" href="#commentSection">
                            ...
                            <div class="competition-body">
                                ...
                                <div class="d-flex">
                                    <form action="{{ route('home.customer.dish.upvote', $dish->id_dish) }}" method="post">
                                        @csrf
                                        <button class="voting {{ $dish->isVoted ? 'voted' :'' }}" type="submit">
                        ...
                        <div class="col-lg-3">
                            <div class="card-main-info">
                                ...
                                <div class="info">
                                    ...
                                    {{-- <div class="order">
                                        <a href="{{ route('home.customer.order.new-order.step-1') }}">
                                            Order
                                        </a>
                                    </div> --}}
                                </div>
